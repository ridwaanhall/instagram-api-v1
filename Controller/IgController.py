...
def code_response(response):
    ...
    if code == 200:
        ...
        return {"code": 300, "message": "Multiple Choices"}
    elif code == 301:
        return {"code": 301, "message": "Moved Permanently"}
    elif code == 302:
        return {"code": 302, "message": "Found (or Moved Temporarily)"}
    elif code == 304:
        return {"code": 304, "message": "Not Modified"}
    elif code == 307:
        return {"code": 307, "message": "Temporary Redirect"}
    elif code == 308:
        return {"code": 308, "message": "Permanent Redirect"}
    elif code == 400:
        ...
        return {"code": 406, "message": "Not Acceptable"}
    elif code == 407:
        return {"code": 407, "message": "Proxy Authentication Required"}
    elif code == 408:
        ...
        return {"code": 411, "message": "Length Required"}
    elif code == 412:
        return {"code": 412, "message": "Precondition Failed"}
    elif code == 413:
        return {"code": 413, "message": "Payload Too Large"}
    elif code == 414:
        return {"code": 414, "message": "URI Too Long"}
    elif code == 415:
        return {"code": 415, "message": "Unsupported Media Type"}
    elif code == 416:
        return {"code": 416, "message": "Range Not Satisfiable"}
    elif code == 417:
        return {"code": 417, "message": "Expectation Failed"}
    elif code == 418:
        return {"code": 418, "message": "I'm a teapot"}
    elif code == 421:
        return {"code": 421, "message": "Misdirected Request"}
    elif code == 422:
        return {"code": 422, "message": "Unprocessable Entity"}
    elif code == 431:
        return {"code": 431, "message": "Request Header Fields Too Large"}
    elif code == 451:
        return {"code": 451, "message": "Unavailable For Legal Reasons"}
    elif code == 500:
        ...
        return {"code": 511, "message": "Network Authentication Required"}
    else:
...
def process_instagram_profile(username):
    ...
    payload = {"instagram_url": username, "type": "profile", "resource": "save"}
...
def process_instagram_story(username):
    ...
    payload = {"instagram_url": username, "type": "story", "resource": "save"}
...
def process_instagram_media(media_url):
    url = "https://www.save-free.com/process"
    headers = {
        "Origin": "https://www.save-free.com",
        "Referer": "https://www.save-free.com/id/profile-downloader/",
    ...
    payload = {"instagram_url": media_url, "type": "media", "resource": "save"}
